...
const AjouterFeedback = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const FeedbackData = {
      ...
      date_feedback: formData.date_feedback,
      objet: formData.objet,
      description: formData.description,
    };

    try {
      const response = await postData('/ajouter_Feedback', FeedbackData);
  ...
  return (
    <Box
      ...
      autoComplete="off"
    >
      <h2 style={{ marginLeft: 20 }}>Ajouter Feedback</h2>
...
export default AjouterFeedback;
